...
def run_model_DBLP(args):
    ...
    for i in range(args.repeat):
        ...
        net = HINAC(g, num_classes, in_dims, args.hidden_dim, args.num_layers, args.num_gnns, args.num_heads, args.dropout,
                    temper=args.temperature, num_type=len(node_cnt), beta = args.beta, num_hade_layers=args.num_hade_layers)
...
if __name__ == '__main__':
    ...
    ap.add_argument('--num-layers', type=int, default=2, help='The number of layers of HINAC layer')
    ...
    ap.add_argument('--num-hade-layers', type=int, default=1, help='The number of layers of HADE MLP. Default is 1.')
